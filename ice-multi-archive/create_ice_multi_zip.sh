...
# Zeroc ice-3.6.2 RPMS
# retrieve the rpm one by one. The more general approach does not work
mkdir ice-3.6.2
cd ice-3.6.2
...
wget https://zeroc.com/download/rpm/el6/x86_64/ice-debuginfo-3.6.2-1.el6.x86_64.rpm
